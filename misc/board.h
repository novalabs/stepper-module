...
/*
 * Setup for Stepper module board.
 */

/*
 * Board identifier.
 */
#define BOARD_Stepper_module
#define BOARD_NAME                  "Stepper module"
 ...
 */
#define LINE_SW1                    PAL_LINE(GPIOA, 3U)
#define LINE_SW2                    PAL_LINE(GPIOA, 4U)
#define LINE_SW3                    PAL_LINE(GPIOA, 5U)
#define LINE_SW4                    PAL_LINE(GPIOA, 6U)
#define LINE_STCK                   PAL_LINE(GPIOA, 7U)
#define LINE_JTAG_TMS               PAL_LINE(GPIOA, 13U)
#define LINE_JTAG_TCK               PAL_LINE(GPIOA, 14U)
#define LINE_JTAG_TDI               PAL_LINE(GPIOA, 15U)

#define LINE_FLAG                   PAL_LINE(GPIOB, 0U)
#define LINE_SPI_CS                 PAL_LINE(GPIOB, 1U)
#define LINE_BUSY                   PAL_LINE(GPIOB, 2U)
#define LINE_JTAG_TDO               PAL_LINE(GPIOB, 3U)
#define LINE_LED1                   PAL_LINE(GPIOB, 5U)
...
#define LINE_SW                     PAL_LINE(GPIOB, 10U)
#define LINE_STBY                   PAL_LINE(GPIOB, 11U)
 ...
 * PA3  - SW1                       (input pullup).
 * PA4  - SW2                       (input pullup).
 * PA5  - SW3                       (input pullup).
 * PA6  - SW4                       (input pullup).
 * PA7  - STCK                      (output pushpull maximum).
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOA_PIN0) |       \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOA_SW1) |           \
                                     PIN_OSPEED_HIGH(GPIOA_SW2) |           \
                                     PIN_OSPEED_HIGH(GPIOA_SW3) |           \
                                     PIN_OSPEED_HIGH(GPIOA_SW4) |           \
                                     PIN_OSPEED_HIGH(GPIOA_STCK) |          \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_PIN0, 0) |           \
                                     ...
                                     PIN_AFIO_AF(GPIOA_SW1, 0) |            \
                                     PIN_AFIO_AF(GPIOA_SW2, 0) |            \
                                     PIN_AFIO_AF(GPIOA_SW3, 0) |            \
                                     PIN_AFIO_AF(GPIOA_SW4, 0) |            \
                                     PIN_AFIO_AF(GPIOA_STCK, 0))
 ...
 * GPIOB setup:
 *
 * PB0  - FLAG                      (input pullup).
 * PB1  - SPI_CS                    (output pushpull maximum).
 * PB2  - BUSY                      (input pullup).
 * PB3  - JTAG_TDO                  (alternate 0).
 * PB4  - PIN4                      (input pullup).
 * PB5  - LED1                      (output pushpull maximum).
 * PB6  - I2C_SCL                   (alternate 4).
 * PB7  - I2C_SDA                   (alternate 4).
 * PB8  - CAN_RX                    (alternate 9).
 * PB9  - CAN_TX                    (alternate 9).
 * PB10 - SW                        (output pushpull maximum).
 * PB11 - STBY                      (input pullup).
 * PB12 - PIN12                     (input pullup).
 * PB13 - SPI_SCK                   (alternate 5).
 * PB14 - SPI_MISO                  (alternate 5).
 * PB15 - SPI_MOSI                  (alternate 5).
 */
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_FLAG) |           \
                                     PIN_MODE_OUTPUT(GPIOB_SPI_CS) |        \
                                     PIN_MODE_INPUT(GPIOB_BUSY) |           \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_FLAG) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_SW) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOB_STBY) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN12) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_SPI_SCK) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOB_SPI_MISO) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOB_SPI_MOSI))
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_FLAG) |          \
                                     PIN_OSPEED_HIGH(GPIOB_SPI_CS) |        \
                                     PIN_OSPEED_HIGH(GPIOB_BUSY) |          \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_FLAG) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_SW) |               \
                                     PIN_ODR_HIGH(GPIOB_STBY) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN12) |            \
                                     PIN_ODR_HIGH(GPIOB_SPI_SCK) |          \
                                     PIN_ODR_HIGH(GPIOB_SPI_MISO) |         \
                                     PIN_ODR_HIGH(GPIOB_SPI_MOSI))
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_FLAG, 0) |           \
                                     PIN_AFIO_AF(GPIOB_SPI_CS, 0) |         \
                                     PIN_AFIO_AF(GPIOB_BUSY, 0) |           \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_CAN_RX, 9) |         \
                                     ...
                                     PIN_AFIO_AF(GPIOB_SW, 0) |             \
                                     PIN_AFIO_AF(GPIOB_STBY, 0) |           \
